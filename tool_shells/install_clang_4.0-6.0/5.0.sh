#!/bin/bash
rm -rf cfe-3.5.0.src clang clang-tools-extra-3.5.0.src extra compiler-rt-3.5.0.src compiler-rt llvm-3.5.0.src

tar xvf cfe-3.5.0.src.tar.xz 
tar xvf clang-tools-extra-3.5.0.src.tar.xz 
